...

{
    ...
    public class ADLSRead

    {

        private static string applicationId = "3646b74a-ab4e-49de-ad5d-e638725b501b";     // Also called client id

        private static string clientSecret = "3646b74a-ab4e-49de-ad5d-e638725b501b";

        private static string tenantId = "2b31fc5d-74fe-49df-a518-ae15aef09e70";

        private static string adlsAccountFQDN = "https://dlsmgdev6t6edp06.azuredatalakestore.net";   // full account FQDN, not just the account name like example.azure.datalakestore.net
